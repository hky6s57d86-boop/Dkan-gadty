...
const PRODUCTS = [
  ...
  {
    id: "prayer-1",
    name: "جلابية صلاة نسائية",
    category: "prayer",
    description: "جلال صلاة خفيفة ومريحة بقماش ناعم غير شفاف.",
    price: 75,
    image: "",
    available: true,
  },
